...
RoboCompGridder::Gridder::_iceD_setLocationAndGetPath(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    TPoint iceP_target;
    bool iceP_setFree;
    TPoint iceP_obstacle;
    istr->readAll(iceP_source, iceP_target, iceP_setFree, iceP_obstacle);
    inS.endReadParams();
    Result ret = this->setLocationAndGetPath(::std::move(iceP_source), ::std::move(iceP_target), iceP_setFree, ::std::move(iceP_obstacle), current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(ret);
    inS.endWriteParams();
    return true;
...
/// \cond INTERNAL
void
RoboCompGridder::GridderPrx::_iceI_setLocationAndGetPath(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompGridder::Result>>& outAsync, const TPoint& iceP_source, const TPoint& iceP_target, bool iceP_setFree, const TPoint& iceP_obstacle, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_RoboCompGridder_Gridder_setLocationAndGetPath_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_source, iceP_target, iceP_setFree, iceP_obstacle);
        },
        nullptr);
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::RoboCompGridder::Gridder::_iceI_begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint& iceP_source, const ::RoboCompGridder::TPoint& iceP_target, bool iceP_setFree, const ::RoboCompGridder::TPoint& iceP_obstacle, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ...
    try
    {
        ...
        ostr->write(iceP_source);
        ostr->write(iceP_target);
        ostr->write(iceP_setFree);
        ostr->write(iceP_obstacle);
        result->endWriteParams();
...
RoboCompGridder::Gridder::_iceD_setLocationAndGetPath(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_source);
    istr->read(iceP_target);
    istr->read(iceP_setFree);
    istr->read(iceP_obstacle);
    inS.endReadParams();
    Result ret = this->setLocationAndGetPath(iceP_source, iceP_target, iceP_setFree, iceP_obstacle, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    inS.endWriteParams();
    return true;
