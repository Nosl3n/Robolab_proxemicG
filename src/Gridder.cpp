...
RoboCompGridder::Gridder::_iceD_LineOfSightToTarget(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    TPoint iceP_source;
    TPoint iceP_target;
    float iceP_robot_radius;
    istr->readAll(iceP_source, iceP_target, iceP_robot_radius);
    inS.endReadParams();
    bool ret = this->LineOfSightToTarget(::std::move(iceP_source), ::std::move(iceP_target), iceP_robot_radius, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(ret);
    inS.endWriteParams();
    return true;
...
RoboCompGridder::Gridder::_iceD_getPaths(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    TPoint iceP_target;
    int iceP_max_paths;
    bool iceP_try_closest_free_point;
    bool iceP_target_is_human;
    istr->readAll(iceP_source, iceP_target, iceP_max_paths, iceP_try_closest_free_point, iceP_target_is_human);
    inS.endReadParams();
    Result ret = this->getPaths(::std::move(iceP_source), ::std::move(iceP_target), iceP_max_paths, iceP_try_closest_free_point, iceP_target_is_human, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(ret);
    inS.endWriteParams();
    return true;
...
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_RoboCompGridder_Gridder_ops, iceC_RoboCompGridder_Gridder_ops + 10, current.operation);
    if(r.first == r.second)
    {
...
/// \cond INTERNAL
void
RoboCompGridder::GridderPrx::_iceI_LineOfSightToTarget(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<bool>>& outAsync, const TPoint& iceP_source, const TPoint& iceP_target, float iceP_robot_radius, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_RoboCompGridder_Gridder_LineOfSightToTarget_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_source, iceP_target, iceP_robot_radius);
        },
        nullptr);
}
/// \endcond
...
/// \cond INTERNAL
void
RoboCompGridder::GridderPrx::_iceI_getPaths(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompGridder::Result>>& outAsync, const TPoint& iceP_source, const TPoint& iceP_target, int iceP_max_paths, bool iceP_try_closest_free_point, bool iceP_target_is_human, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_RoboCompGridder_Gridder_getPaths_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_source, iceP_target, iceP_max_paths, iceP_try_closest_free_point, iceP_target_is_human);
        },
        nullptr);
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::RoboCompGridder::Gridder::_iceI_begin_LineOfSightToTarget(const ::RoboCompGridder::TPoint& iceP_source, const ::RoboCompGridder::TPoint& iceP_target, ::Ice::Float iceP_robot_radius, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
::Ice::AsyncResultPtr
IceProxy::RoboCompGridder::Gridder::_iceI_begin_getPaths(const ::RoboCompGridder::TPoint& iceP_source, const ::RoboCompGridder::TPoint& iceP_target, ::Ice::Int iceP_max_paths, bool iceP_try_closest_free_point, bool iceP_target_is_human, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ...
    try
    {
        ...
        ostr->write(iceP_source);
        ostr->write(iceP_target);
        ostr->write(iceP_max_paths);
        ostr->write(iceP_try_closest_free_point);
        ostr->write(iceP_target_is_human);
        result->endWriteParams();
...
RoboCompGridder::Gridder::_iceD_LineOfSightToTarget(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    TPoint iceP_source;
    TPoint iceP_target;
    ::Ice::Float iceP_robot_radius;
    istr->read(iceP_source);
    istr->read(iceP_target);
    istr->read(iceP_robot_radius);
    inS.endReadParams();
    bool ret = this->LineOfSightToTarget(iceP_source, iceP_target, iceP_robot_radius, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    inS.endWriteParams();
    return true;
...
RoboCompGridder::Gridder::_iceD_getPaths(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    TPoint iceP_source;
    TPoint iceP_target;
    ::Ice::Int iceP_max_paths;
    bool iceP_try_closest_free_point;
    bool iceP_target_is_human;
    istr->read(iceP_source);
    istr->read(iceP_target);
    istr->read(iceP_max_paths);
    istr->read(iceP_try_closest_free_point);
    istr->read(iceP_target_is_human);
    inS.endReadParams();
    Result ret = this->getPaths(iceP_source, iceP_target, iceP_max_paths, iceP_try_closest_free_point, iceP_target_is_human, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    inS.endWriteParams();
    return true;
...
RoboCompGridder::Gridder::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_RoboCompGridder_Gridder_all, iceC_RoboCompGridder_Gridder_all + 10, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
