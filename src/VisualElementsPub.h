...
struct TObject
{
     ...
     */
    std::tuple<const int&, const int&, const ::RoboCompCamera360RGB::TImage&, const ::RoboCompVisualElementsPub::TAttributes&> ice_tuple() const
    {
        return std::tie(id, type, image, attributes);
    }
};
...
struct StreamReader<::RoboCompVisualElementsPub::TObject, S>
{
    ...
    {
        istr->readAll(v.id, v.type, v.image, v.attributes);
    }
};
