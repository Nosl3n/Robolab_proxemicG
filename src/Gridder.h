...
public:
    ...
    virtual Result setLocationAndGetPath(TPoint source, TPoint target, bool setFree, TPoint obstacle, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    Result setLocationAndGetPath(const TPoint& source, const TPoint& target, bool setFree, const TPoint& obstacle, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::RoboCompGridder::Result>(true, this, &GridderPrx::_iceI_setLocationAndGetPath, source, target, setFree, obstacle, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto setLocationAndGetPathAsync(const TPoint& source, const TPoint& target, bool setFree, const TPoint& obstacle, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompGridder::Result>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompGridder::Result, P>(false, this, &GridderPrx::_iceI_setLocationAndGetPath, source, target, setFree, obstacle, context);
    }

    ::std::function<void()>
    setLocationAndGetPathAsync(const TPoint& source, const TPoint& target, bool setFree, const TPoint& obstacle,
                               ::std::function<void(::RoboCompGridder::Result)> response,
                               ::std::function<void(::std::exception_ptr)> ex = nullptr,
                               ::std::function<void(bool)> sent = nullptr,
                               const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompGridder::Result>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompGridder::GridderPrx::_iceI_setLocationAndGetPath, source, target, setFree, obstacle, context);
    }

    /// \cond INTERNAL
    void _iceI_setLocationAndGetPath(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompGridder::Result>>&, const TPoint&, const TPoint&, bool, const TPoint&, const ::Ice::Context&);
    /// \endcond
...
public:
    ...
    ::RoboCompGridder::Result setLocationAndGetPath(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, bool setFree, const ::RoboCompGridder::TPoint& obstacle, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_setLocationAndGetPath(_iceI_begin_setLocationAndGetPath(source, target, setFree, obstacle, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, bool setFree, const ::RoboCompGridder::TPoint& obstacle, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_setLocationAndGetPath(source, target, setFree, obstacle, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, bool setFree, const ::RoboCompGridder::TPoint& obstacle, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setLocationAndGetPath(source, target, setFree, obstacle, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, bool setFree, const ::RoboCompGridder::TPoint& obstacle, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setLocationAndGetPath(source, target, setFree, obstacle, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, bool setFree, const ::RoboCompGridder::TPoint& obstacle, const ::RoboCompGridder::Callback_Gridder_setLocationAndGetPathPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setLocationAndGetPath(source, target, setFree, obstacle, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, bool setFree, const ::RoboCompGridder::TPoint& obstacle, const ::Ice::Context& context, const ::RoboCompGridder::Callback_Gridder_setLocationAndGetPathPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setLocationAndGetPath(source, target, setFree, obstacle, context, cb, cookie);
    }
...
private:
    ...
    ::Ice::AsyncResultPtr _iceI_begin_setLocationAndGetPath(const ::RoboCompGridder::TPoint&, const ::RoboCompGridder::TPoint&, bool, const ::RoboCompGridder::TPoint&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual Result setLocationAndGetPath(const TPoint& source, const TPoint& target, bool setFree, const TPoint& obstacle, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_setLocationAndGetPath(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
