...
struct Result
{
    ...
    {
        return std::tie(paths, timestamp, error_msg, valid);
    }
};
...
public:
    ...
    virtual bool LineOfSightToTarget(TPoint source, TPoint target, float robot_radius, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    ...
    virtual Result getPaths(TPoint source, TPoint target, int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    bool LineOfSightToTarget(const TPoint& source, const TPoint& target, float robot_radius, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<bool>(true, this, &GridderPrx::_iceI_LineOfSightToTarget, source, target, robot_radius, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto LineOfSightToTargetAsync(const TPoint& source, const TPoint& target, float robot_radius, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<bool>>().get_future())
    {
        return _makePromiseOutgoing<bool, P>(false, this, &GridderPrx::_iceI_LineOfSightToTarget, source, target, robot_radius, context);
    }

    ::std::function<void()>
    LineOfSightToTargetAsync(const TPoint& source, const TPoint& target, float robot_radius,
                             ::std::function<void(bool)> response,
                             ::std::function<void(::std::exception_ptr)> ex = nullptr,
                             ::std::function<void(bool)> sent = nullptr,
                             const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompGridder::GridderPrx::_iceI_LineOfSightToTarget, source, target, robot_radius, context);
    }
    ...
    Result getPaths(const TPoint& source, const TPoint& target, int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::RoboCompGridder::Result>(true, this, &GridderPrx::_iceI_getPaths, source, target, max_paths, try_closest_free_point, target_is_human, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getPathsAsync(const TPoint& source, const TPoint& target, int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompGridder::Result>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompGridder::Result, P>(false, this, &GridderPrx::_iceI_getPaths, source, target, max_paths, try_closest_free_point, target_is_human, context);
    }

    ::std::function<void()>
    getPathsAsync(const TPoint& source, const TPoint& target, int max_paths, bool try_closest_free_point, bool target_is_human,
                  ::std::function<void(::RoboCompGridder::Result)> response,
                  ::std::function<void(::std::exception_ptr)> ex = nullptr,
                  ::std::function<void(bool)> sent = nullptr,
                  const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompGridder::Result>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompGridder::GridderPrx::_iceI_getPaths, source, target, max_paths, try_closest_free_point, target_is_human, context);
    }
...
struct StreamReader<::RoboCompGridder::Result, S>
{
    ...
    {
        istr->readAll(v.paths, v.timestamp, v.error_msg, v.valid);
    }
};
...
public:
    ...
    bool LineOfSightToTarget(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Float robot_radius, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_LineOfSightToTarget(_iceI_begin_LineOfSightToTarget(source, target, robot_radius, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_LineOfSightToTarget(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Float robot_radius, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_LineOfSightToTarget(source, target, robot_radius, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_LineOfSightToTarget(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Float robot_radius, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_LineOfSightToTarget(source, target, robot_radius, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_LineOfSightToTarget(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Float robot_radius, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_LineOfSightToTarget(source, target, robot_radius, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_LineOfSightToTarget(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Float robot_radius, const ::RoboCompGridder::Callback_Gridder_LineOfSightToTargetPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_LineOfSightToTarget(source, target, robot_radius, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_LineOfSightToTarget(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Float robot_radius, const ::Ice::Context& context, const ::RoboCompGridder::Callback_Gridder_LineOfSightToTargetPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_LineOfSightToTarget(source, target, robot_radius, context, cb, cookie);
    }
...
public:
    ...
    ::RoboCompGridder::Result getPaths(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getPaths(_iceI_begin_getPaths(source, target, max_paths, try_closest_free_point, target_is_human, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getPaths(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getPaths(source, target, max_paths, try_closest_free_point, target_is_human, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getPaths(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPaths(source, target, max_paths, try_closest_free_point, target_is_human, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPaths(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPaths(source, target, max_paths, try_closest_free_point, target_is_human, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPaths(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::RoboCompGridder::Callback_Gridder_getPathsPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPaths(source, target, max_paths, try_closest_free_point, target_is_human, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPaths(const ::RoboCompGridder::TPoint& source, const ::RoboCompGridder::TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Context& context, const ::RoboCompGridder::Callback_Gridder_getPathsPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPaths(source, target, max_paths, try_closest_free_point, target_is_human, context, cb, cookie);
    }
...
public:
    ...
    virtual bool LineOfSightToTarget(const TPoint& source, const TPoint& target, ::Ice::Float robot_radius, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_LineOfSightToTarget(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
    ...
    virtual Result getPaths(const TPoint& source, const TPoint& target, ::Ice::Int max_paths, bool try_closest_free_point, bool target_is_human, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getPaths(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
